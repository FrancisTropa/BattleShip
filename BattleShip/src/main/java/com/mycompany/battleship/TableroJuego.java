...
import Errores.nombreVariableVacia;
...
public class TableroJuego extends JFrame {
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b1.getName().split("");
        generarCoordenada(coordenada);
    ...
    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b2.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b3.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b4ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b4.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b5ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b5.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b6ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b6.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b7ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b7.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b8ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b8.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b9ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b9.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void b10ActionPerformed(java.awt.event.ActionEvent evt) {
        piezasDibujables = piezasDibujables - 1;
        String[] coordenada = b10.getClass().getSimpleName().split("");
        generarCoordenada(coordenada);
    ...
    private void generarCoordenada(String[] coordenada) {
        int y;
        int x = Integer.parseInt(coordenada[1]) - 1;//obtiene la coordenada x dependiendo de la coordenada de los numeros en la interfaz, esta en el nombre del boton
        //dependiendo de la letra de la columna el valor de la coordenada y sera alguna de las opciones
        if (coordenada[0].equalsIgnoreCase("a")) {
            y = 0;
